...
# GREENLETS = 10 #Max number of greenlets to use.Defaults to 1.
...
# SCHEDULER_INTERVAL = 2 #Seconds between scheduler checks.Defaults to 60 seconds, only ints are acceptable.
